...
load 'lib/biointerchange/writers/gff3_rdf_ntriples.rb'
load 'lib/biointerchange/gff3/feature_set.rb'
load 'lib/biointerchange/gff3/feature.rb'
...
describe BioInterchange::Genomics::RDFWriter do
  describe 'serialization of GFF3 models' do
    it 'empty document' do
      ...
      BioInterchange::Genomics::RDFWriter.new(ostream).serialize(BioInterchange::Genomics::FeatureSet.new())
      ostream.close
    ...
    it 'model with three features' do
      istream, ostream = IO.pipe
      set = BioInterchange::Genomics::FeatureSet.new()
      feature = BioInterchange::Genomics::Feature.new(
          'GRCh37.1',
          'NCBI',
          ...
          32890664,
          0.1,
          BioInterchange::Genomics::Feature::POSITIVE,
          nil,
