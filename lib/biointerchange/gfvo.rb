...
class GFVO
  ...
  # (http://www.biointerchange.org/gfvo#database)
  def self.database
    return RDF::URI.new('http://www.biointerchange.org/gfvo#database')
  end
  ...
  def self.is_object_property?(uri)
    ...
    if uri == RDF::URI.new('http://www.biointerchange.org/gfvo#database') then
      return true
    end
